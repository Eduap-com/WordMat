...
;SetupIconFile=C:\Users\Mikael\SkyDrive\Dokumenter\Eduap\WordMat\images not install\WordMatIkon.ico
WizardImageFile=C:\Users\mikae\OneDrive\Dokumenter\Eduap\WordMat\images not install\WordMatInstallImage.bmp
WizardImageStretch=no
;SourceDir=C:\Users\Mikael2\Documents\Eduap\WordMat
SourceDir=C:\Users\mikae\OneDrive\Dokumenter\Eduap\WordMat\
;OutputDir=C:\Users\Mikael2\Documents\Eduap\WordMat\Inno Setup
OutputDir=C:\Users\mikae\OneDrive\Dokumenter\Eduap\WordMat\Inno Setup
...
Name: "da"; MessagesFile: compiler:Languages\Danish.isl  ; LicenseFile: "License_da.txt"
Name: "sp"; MessagesFile: compiler:Languages\Spanish.isl ; LicenseFile: "License_en.txt"
...
da.NoWord=Du har ikke installeret Word 2007, 2010, 2013 eller 2016. Installationen afsluttes.
...
Source: WordMatLommeregner.docm; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly uninsrestartdelete
Source: SetupGraph-4.4.2.exe; DestDir: {app}; Components: Graph ; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly uninsrestartdelete deleteafterinstall
Source: GeoGebra-Windows-Installer-5-0-328-0.exe; DestDir: {app}; Components: GeoGebra ; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly uninsrestartdelete deleteafterinstall
...
Source: FormelSamling.dotx; DestDir: {%appdata}\Microsoft\Document Building Blocks\; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly
Source: Excelfiler\*; DestDir: {app}\ExcelFiler; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly
Source: Images\*; DestDir: {app}\Images; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly
Source: GeoGebraFiler\GeoGebra.ggb; DestDir: {app}; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly
;Source: GeoGebraFiler\geogebra_thumbnail.png; DestDir: {app}\GeoGebraFiler\; Flags: ignoreversion
Source: graphtemplate.grf; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly 
Source: OpretWordMenu.vbs; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: ReaktiverWordMat.vbs; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: WordMatManual.docx; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: WordMatManual_english.docx; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Figurer.docx; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Figurer.docx; DestDir: {%appdata}\WordMat\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Figurer_english.docx; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Figurer_english.docx; DestDir: {%appdata}\WordMat\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Figurer_spansk.docx; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Figurer_spansk.docx; DestDir: {%appdata}\WordMat\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\MatFormler.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\MatFormler.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\MatFormler_spansk.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\MatFormler_spansk.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\MatFormler_english.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\MatFormler_english.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\FysikFormler.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\FysikFormler.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\FysikFormler_spansk.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\FysikFormler_spansk.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\KemiFormler.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\KemiFormler.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: Formelsamlinger\KemiFormler_spansk.docx; DestDir: {app}\Formulae; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: Formelsamlinger\KemiFormler_spansk.docx; DestDir: {%appdata}\WordMat\Formulae\; Check: VOverWriteDocs; Flags: ignoreversion uninsneveruninstall overwritereadonly uninsremovereadonly
Source: MathMenu.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: MathMenu.tlb; DestDir: {app}; Flags: ignoreversion regtypelib overwritereadonly uninsremovereadonly
...
Source: dotNetFx40_Client_setup.exe; DestDir: {tmp}; Flags: dontcopy

Source: Maxima-5.30.0\*; DestDir: {app}\Maxima-5.30.0; Flags: ignoreversion recursesubdirs overwritereadonly uninsremovereadonly; AfterInstall: ReplacePathInBat(); 
...
;egne mac-filer
;Source: mac-filer\*; DestDir: {app}\Maxima-5.25.1-gcl\share\maxima\5.25.1\share; Flags: ignoreversion overwritereadonly uninsremovereadonly
Source: mac-filer\SolveReal.mac; DestDir: {app}\Maxima-5.30.0\share\maxima\5.30.0\share\contrib; Flags: ignoreversion overwritereadonly uninsremovereadonly
...
Filename: {app}\GeoGebra-Windows-Installer-5-0-328-0.exe; Parameters: "/S";check:InstallGeoGebra; StatusMsg: "Installerer GeoGebra...";  Components: GeoGebra ;
...
Name: "{group}\wxMaxima"; Filename: "{app}\Maxima-5.30.0\wxMaxima\wxMaxima.exe"; WorkingDir: "{app}"
...
begin
   ...
   try
    ...
    while winHwnd <> 0 do
    begin
      if MsgBox(ExpandConstant('{cm:CloseWord}'), mbInformation, MB_OKCANCEL)=IDOK then 
        begin
...
//          MsgBox(GetCmdTail, mbInformation, MB_OK);
  ...
  if not (Word12Installed or Word14Installed or Word15Installed or Word16Installed) then begin
    MsgBox(ExpandConstant('{cm:NoWord}'), mbInformation, MB_OK);
    Result := False;
  end
...
begin
  ReplaceApp('Maxima-5.30.0\bin\maxima.bat');
  ReplaceApp('Maxima-5.30.0\bin\maximaunit.bat');  
end;
