...
Source: ExternalPrograms\GeoGebra-Windows-Installer-5-0-791-0.exe; DestDir: {app}; Components: GeoGebra ; Flags: ignoreversion overwritereadonly replacesameversion uninsremovereadonly uninsrestartdelete deleteafterinstall
...
Filename: {app}\GeoGebra-Windows-Installer-5-0-791-0.exe; Parameters: "/S";check:InstallGeoGebra; StatusMsg: "Installerer GeoGebra...";  Components: GeoGebra ;
