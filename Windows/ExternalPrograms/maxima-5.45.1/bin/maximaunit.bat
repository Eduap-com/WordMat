...
if not exist "%maxima_prefix%" set maxima_prefix=C:\PROGRA~1\WordMat\Maxima-5.45.1
if not exist "%maxima_prefix%" set maxima_prefix=C:\PROGRA~2\WordMat\Maxima-5.45.1
if not exist "%maxima_prefix%" set maxima_prefix=%ProgramFiles(x86)%\WordMat\Maxima-5.45.1
if not exist "%maxima_prefix%" set maxima_prefix=%ProgramFiles%\WordMat\Maxima-5.45.1
