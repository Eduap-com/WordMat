...
rem set maxima_prefix=C:\Program Files (x86)\Maxima-sbcl-5.38.1
rem set maxima_prefix=C:\PROGRA~1\MAXIMA~1.0
if not exist "%maxima_prefix%" set maxima_prefix=D:\PROGRA~1\WordMat\MAXIMA~1.1
if not exist "%maxima_prefix%" set maxima_prefix=C:\PROGRA~1\WordMat\Maxima-sbcl-5.38.1
if not exist "%maxima_prefix%" set maxima_prefix=C:\PROGRA~2\WordMat\Maxima-sbcl-5.38.1
if not exist "%maxima_prefix%" set maxima_prefix=%ProgramFiles(x86)%\WordMat\Maxima-sbcl-5.38.1
if not exist "%maxima_prefix%" set maxima_prefix=%ProgramFiles%\WordMat\Maxima-sbcl-5.38.1
...
:doclisp
if exist "%maxima_imagesdir%\binary-clisp\maximaunit.exe" goto doclisp_exec
...
:clisp_exec
"%maxima_imagesdir%\binary-clisp\maximaunit.exe" %lisp_options% -q "" -- %*
goto end
...
if exist "%maxima_imagesdir%\binary-sbcl\maximaunit.exe" goto dosbcl_exec
...
sbcl.exe --core "%maxima_imagesdir%\binary-sbcl\maximaunit.core" --noinform %lisp_options% --end-runtime-options --eval %start_maxima% --end-toplevel-options %*
goto end
:dosbcl_exec
"%maxima_imagesdir%\binary-sbcl\maximaunit.exe" %lisp_options% --noinform --end-runtime-options --eval "(cl-user::run)" --end-toplevel-options %*
goto end
