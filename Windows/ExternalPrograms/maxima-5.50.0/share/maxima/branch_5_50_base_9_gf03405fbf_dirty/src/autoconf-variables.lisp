...
(defparameter *autoconf-prefix* "C:/maxima-5.50.0")
(defparameter *autoconf-exec_prefix* "C:/maxima-5.50.0")
(defparameter *autoconf-package* "maxima")
(defparameter *autoconf-version* "branch_5_50_base_9_gf03405fbf_dirty")
(defparameter *autoconf-libdir* "C:/maxima-5.50.0/lib")
(defparameter *autoconf-libexecdir* "C:/maxima-5.50.0/libexec")
(defparameter *autoconf-datadir* "C:/maxima-5.50.0/share")
(defparameter *autoconf-infodir* "C:/maxima-5.50.0/share/info")
...
(defparameter *maxima-source-root* "/home/dauti/Software/maxima-code/maxima-5.50.0/crosscompile-windows/build/maxima-prefix/src/maxima")
