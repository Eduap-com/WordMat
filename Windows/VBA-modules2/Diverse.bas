...
Sub RegKeySave(ByVal i_RegKey As String, ByVal i_Value As String)
'
#If Mac Then
...
Sub TestFolder()
    PrepareMaxima False
    Dim s As String
'    MsgBox MaxProc.RegKeyExists("HKEY_CURRENT_USER\Software\WordMat\Settings\AppVersion")
    
'    MaxProc.RegKeySave "HKEY_CURRENT_USER\Software\WordMat\Settings\AppVersion", "1.34"
    s = MaxProc.RegKeyRead("HKEY_CURRENT_USER\Software\WordMat\Settings\AntalBeregninger")
    MsgBox s
End Sub
