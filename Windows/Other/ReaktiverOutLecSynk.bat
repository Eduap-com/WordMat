...
:: ============================================================
::  Aktiverer deaktiverede tilføjelsesprogrammer i Outlook
::
...
::)
call :SletNoegle "HKCU\Software\Microsoft\Office\16.0\Outlook\Resiliency\DisabledItems"
...
if "%_fejl%"=="1" (
    ...
    echo  luk Outlook helt ned først.
    echo ***************************************************************
    echo.
) else if "%_slettet%"=="0" (
    ...
    echo Alle deaktiverede tilføjelsesprogrammer i Outlook er nu blevet aktiveret.
    echo.
)

echo Bemærk at Tilføjelsesprogrammer også bare kan være inaktive.
echo Hvis OutLecSynk bare er inaktivt er du nødt til at ændre indstillingen manuelt under:
