...
' saves a backup of this document
    ...
    Do While currentFile <> ""
        ...
        currentNumber = val(Mid(currentFile, Len(fileName) + 1))
    ...
    destinationPath = backupFolder & fileName & fileNumber
    
    ' Save a copy of the active document
    ActiveDocument.SaveAs2 fileName:=destinationPath
    ' Close the new document
    Documents(destinationPath).Close SaveChanges:=wdDoNotSaveChanges
