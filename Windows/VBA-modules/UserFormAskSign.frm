...
Private Sub UserForm_Activate()
    Me.Caption = TT.A(818)
    Label1.Caption = TT.A(742)
    Label_statesign.Caption = TT.A(743)
    OptionButton_positiv.Caption = "+ " & TT.A(819)
    OptionButton_nul.Caption = "0 " & TT.A(821)
    OptionButton_negativ.Caption = "- " & TT.A(820)
End Sub
