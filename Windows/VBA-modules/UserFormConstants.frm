...
Private Sub CommandButton_ok_Click()
    ...
    If CheckBox_ge.Value = True Then Text = Text & "g_" & TT.A(255) & "=9" & DecSeparator & "82m" & MaximaGangeTegn & "s^-2" & ListSeparator
    ...
    If CheckBox_cvand.Value = True Then Text = Text & "c_" & TT.A(256) & "=4181 J" & MaximaGangeTegn & "kg^-1" & MaximaGangeTegn & "K^-1" & ListSeparator
    If CheckBox_calu.Value = True Then Text = Text & "c_alu=897 J" & MaximaGangeTegn & "kg^-1" & MaximaGangeTegn & "K^-1" & ListSeparator
    If CheckBox_ccop.Value = True Then Text = Text & "c_" & TT.A(257) & "=385 J" & MaximaGangeTegn & "kg^-1" & MaximaGangeTegn & "K^-1" & ListSeparator
    If CheckBox_cjern.Value = True Then Text = Text & "c_" & TT.A(258) & "=450 J" & MaximaGangeTegn & "kg^-1" & MaximaGangeTegn & "K^-1" & ListSeparator
    ...
    If CheckBox_mj.Value = True Then Text = Text & "m_" & TT.A(255) & "=5" & DecSeparator & "9737" & MaximaGangeTegn & "10^24 kg" & ListSeparator
    If CheckBox_rjord.Value = True Then Text = Text & "r_" & TT.A(255) & "=6371km" & ListSeparator
    If CheckBox_AU.Value = True Then Text = Text & "AU=1" & DecSeparator & "50" & MaximaGangeTegn & "10^11 m" & ListSeparator
    If CheckBox_mmoon.Value = True Then Text = Text & "m_" & TT.A(259) & "=7" & DecSeparator & "3477" & MaximaGangeTegn & "10^22 kg" & ListSeparator
    If CheckBox_rmoon.Value = True Then Text = Text & "r_" & TT.A(259) & "=1737km" & ListSeparator
    If CheckBox_msol.Value = True Then Text = Text & "m_" & TT.A(260) & "=1" & DecSeparator & "98892" & MaximaGangeTegn & "10^30 kg" & ListSeparator
...
' ChrW(&H2092)  _0
    ...
    Me.Caption = TT.A(70)
    MultiPage1.Pages(0).Caption = TT.A(261)
    MultiPage1.Pages(1).Caption = TT.A(262)
    MultiPage1.Pages(2).Caption = TT.A(263)
    MultiPage1.Pages(3).Caption = TT.A(264)
    MultiPage1.Pages(4).Caption = TT.A(265)
    Label_cancel.Caption = TT.Cancel
    Label_ok.Caption = TT.OK
    Label1.Caption = TT.A(71)
    
    CheckBox_c.Caption = "c = 299792458 m s" & ChrW(&H207B) & ChrW(185) & "   -   " & TT.A(266)
    CheckBox_planck.Caption = "h = 6" & DecSeparator & "63 " & g & " 10" & ChrW(&H207B) & ChrW(179) & ChrW(&H2074) & " Js   -   " & TT.A(267)
    CheckBox_planckev.Caption = "h = 4" & DecSeparator & "13566733 " & g & " 10" & ChrW(&H207B) & ChrW(185) & ChrW(&H2075) & " eVs   -   " & TT.A(268)
    CheckBox_G.Caption = "G = 6" & DecSeparator & "67428 " & g & " 10" & ChrW(&H207B) & ChrW(185) & ChrW(185) & " Nm" & ChrW(178) & " kg" & ChrW(&H207B) & ChrW(178) & "   -   " & TT.A(269)
    CheckBox_ge.Caption = "g_" & TT.A(255) & " = 9" & DecSeparator & "82 m s" & ChrW(&H207B) & ChrW(178) & "   -   " & TT.A(270)
    CheckBox_e.Caption = "e" & ChrW(&H2097) & " = 1" & DecSeparator & "602176487 " & g & " 10" & ChrW(&H207B) & ChrW(185) & ChrW(&H2079) & " C    -   " & TT.A(271)
    CheckBox_NA.Caption = "N_A = 6" & DecSeparator & "02214179 " & g & " 10" & ChrW(178) & ChrW(179) & " mol" & ChrW(&H207B) & ChrW(185) & "   -   " & TT.A(272)
    CheckBox_R.Caption = "R = 8" & DecSeparator & "314472 J/(mol K)    -    " & TT.A(273)
    CheckBox_R2.Caption = "R = 0" & DecSeparator & "0821 l atm/(mol K)    -    " & TT.A(273)
    CheckBox_k.Caption = "k = 1" & DecSeparator & "3806504 " & g & " 10" & ChrW(&H207B) & ChrW(178) & ChrW(179) & " J K" & ChrW(&H207B) & ChrW(185) & "   -   " & TT.A(274)
    CheckBox_mu0.Caption = ChrW(956) & ChrW(&H2092) & " = 4" & ChrW(960) & g & " 10" & ChrW(&H207B) & ChrW(&H2077) & " N A" & ChrW(&H207B) & ChrW(178) & "   -   " & TT.A(275)
    CheckBox_e0.Caption = "e" & ChrW(&H2092) & " = 8" & DecSeparator & "854187817 " & g & " 10" & ChrW(&H207B) & ChrW(185) & ChrW(178) & " F m" & ChrW(&H207B) & ChrW(185) & "   -   " & TT.A(276) & " = 1/(" & ChrW(956) & ChrW(&H2092) & "c" & ChrW(178) & ")"
    CheckBox_coulomb.Caption = "k = 8" & DecSeparator & "99 " & g & " 10" & ChrW(&H2079) & " N m" & ChrW(178) & " C" & ChrW(&H207B) & ChrW(178) & "   -   " & TT.A(277)
    CheckBox_sigma.Caption = ChrW(963) & " = 5" & DecSeparator & "670400 " & g & " 10" & ChrW(&H207B) & ChrW(&H2078) & " W m" & ChrW(&H207B) & ChrW(178) & " K" & ChrW(&H207B) & ChrW(&H2074) & "   -   " & TT.A(278)
    
    CheckBox_u.Caption = "u = 1" & DecSeparator & "660 538 782 " & g & " 10" & ChrW(&H207B) & ChrW(178) & ChrW(&H2077) & " kg    -   " & TT.A(279)
    CheckBox_uev.Caption = "u = 931" & DecSeparator & "494 028 MeV c" & ChrW(&H207B) & ChrW(178) & "    -   " & TT.A(280)
    
    CheckBox_cvand.Caption = "c_" & TT.A(256) & " = 4181 J kg" & ChrW(&H207B) & ChrW(185) & " K" & ChrW(&H207B) & ChrW(185) & "    -   " & TT.A(281) & " " & TT.A(256)
    CheckBox_calu.Caption = "c_alu = 897 J kg" & ChrW(&H207B) & ChrW(185) & " K" & ChrW(&H207B) & ChrW(185) & "    -   " & TT.A(281) & " aluminium"
    CheckBox_ccop.Caption = "c_" & TT.A(257) & " = 385 J kg" & ChrW(&H207B) & ChrW(185) & " K" & ChrW(&H207B) & ChrW(185) & "    -   " & TT.A(281) & " " & TT.A(257)
    CheckBox_cjern.Caption = "c_" & TT.A(258) & " = 450 J kg" & ChrW(&H207B) & ChrW(185) & " K" & ChrW(&H207B) & ChrW(185) & "    -   " & TT.A(281) & " " & TT.A(258)
    
    CheckBox_me.Caption = "m" & ChrW(&H2091) & " = 5" & DecSeparator & "485 799 0943 " & g & " 10" & ChrW(&H207B) & ChrW(&H2074) & " u   -   " & TT.A(282)
    CheckBox_mekg.Caption = "m" & ChrW(&H2091) & " = 9" & DecSeparator & "109 382 15 " & g & " 10" & ChrW(&H207B) & ChrW(179) & ChrW(185) & " kg   -   " & TT.A(282) & " " & TT.A(283)
    CheckBox_mp.Caption = "m" & ChrW(&H209A) & " = 1" & DecSeparator & "00727646677 u   -   " & TT.A(284)
    CheckBox_mn.Caption = "m" & ChrW(&H2099) & " = 1" & DecSeparator & "00866491597 u   -   " & TT.A(285)
    
    CheckBox_mj.Caption = "m_" & TT.A(255) & " = 5" & DecSeparator & "9737 " & g & " 10" & ChrW(178) & ChrW(&H2074) & " kg   -   " & TT.A(286)
    CheckBox_rjord.Caption = "r_" & TT.A(255) & " = 6371 km    -   " & TT.A(287)
    CheckBox_AU.Caption = "AU = 1" & DecSeparator & "50 " & g & " 10" & ChrW(185) & ChrW(185) & " m   -   " & TT.A(288)
    CheckBox_msol.Caption = "m_" & TT.A(260) & " = 1" & DecSeparator & "98892 " & g & " 10" & ChrW(179) & ChrW(&H2070) & " kg   -   " & TT.A(289)
    CheckBox_mmoon.Caption = "m_" & TT.A(259) & " = 7" & DecSeparator & "3477 " & g & " 10" & ChrW(178) & ChrW(178) & " kg   -   " & TT.A(290)
    CheckBox_rmoon.Caption = "r_" & TT.A(259) & " = 1737 km    -   " & TT.A(291)
End Sub
