...
\begin{equation*}\int_{1}^{10}\sqrt{x^{-2}+1} dx=-\left(\frac{\ln \left(\sqrt{101}+1\right)}{2}\right)+\frac{\ln \left(\sqrt{101}-1\right)}{2}+\frac{\ln \left(\sqrt{2}+1\right)}{2}-\frac{\ln \left(\sqrt{2}-1\right)}{2}+\sqrt{101}-\sqrt{2}\end{equation*}
\newpage
-------------------------------Run testmodule here------------------------------------
\begin{equation*}Slet definitioner:\end{equation*}
