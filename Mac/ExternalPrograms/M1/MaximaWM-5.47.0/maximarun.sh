#!/usr/bin/env zsh
# Denne fil er til for at kunne starte Maxima helt normalt bla for at kunne lave maxima.core. Den skal ligge i MaximaWM
...
"$MAXIMA_PREFIX/bin/sbcl" --core "$MAXIMA_PREFIX/lib/maxima/5.47.0/binary-sbcl/maxima.core"
