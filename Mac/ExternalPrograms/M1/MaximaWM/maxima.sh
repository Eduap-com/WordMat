...
"$MAXIMA_PREFIX/bin/Maximatimeout" --signal=0 --kill-after=$MaxTime $MaxTime "$MAXIMA_PREFIX/bin/sbcl" --core "$MAXIMA_PREFIX/lib/maxima/5.50.0/binary-sbcl/maxima.core" --noinform --end-runtime-options --batch-string="$2" 
