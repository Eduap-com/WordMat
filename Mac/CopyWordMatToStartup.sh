...
Echo "*************************************************************"
Echo "*This script copies WordMat.dotm and P,P2 To Startup folder *"
Echo "*************************************************************"
...
sudo cp $MacFolder/WordMat.dotm /Library/Application\ Support/Microsoft/Office365/User\ Content.localized/Startup.localized/Word
sudo cp $MacFolder/WordMatP.dotm /Library/Application\ Support/Microsoft/Office365/User\ Content.localized/Startup.localized/Word
sudo cp $MacFolder/WordMatP2.dotm /Library/Application\ Support/Microsoft/Office365/User\ Content.localized/Startup.localized/Word
